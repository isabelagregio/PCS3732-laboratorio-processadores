...
void mostrarResultado(uint64_t valor) {
  ...
  // Na divisão, será mostrado o quociente.
...
// Implementação do desafio no ESP32 em C/C++.
// Divisão inteira por subtrações sucessivas.
// Critério de parada: o dividendo restante fica menor que o divisor.
// Saídas: quociente em r.valor e resto em r.resto.
